/*
  ...
  Usage:
    ...
    modify by pinke@trydone.com
    1 popup.bind('targetElement',true) for left mouse click;
    2 popup area auto check.
*/
...
PopupMenu.prototype = {
    ...
    bind: function(element, useLeft) {
        ...
        this.useLeftButtom = useLeft;
        this.target = element;
        this.target.onclick = function(e) {

            if (self.useLeftButtom != undefined) {
    ...
    setPos: function(e) {
        ...
        var w = this.width ? this.width : 150;
        if (x + w > document.body.availWidth) {
            x = document.body.availWidth - w;
        }
